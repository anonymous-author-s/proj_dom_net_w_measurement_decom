...
parser.add_argument('--scope', default='test_ct_img2img', dest='scope')
...
# parser.add_argument('--dir_result', default='/mnt/sda/Shared/Projects/sparse_view_ct_w_fhbp/results', dest='dir_result')
# parser.add_argument('--dir_data', default='/mnt/sda/Shared/datasets/aapm/raw', dest='dir_data')

parser.add_argument('--dir_checkpoint', default='./checkpoints', dest='dir_checkpoint')
parser.add_argument('--dir_log', default='./logs', dest='dir_log')
parser.add_argument('--dir_result', default='./results', dest='dir_result')
parser.add_argument('--dir_data', default='/home/yoseobhan/datasets/aapm/raw', dest='dir_data')
...
# parser.add_argument('--downsample', type=int, default=None, dest='downsample')
parser.add_argument('--downsample', type=int, default=3, dest='downsample')

# parser.add_argument('--num_upscale', type=int, default=3, dest='num_upscale')
# parser.add_argument('--factor_upscale', '--list', nargs='+', type=int, default=[2, 2, 2], dest='factor_upscale')
